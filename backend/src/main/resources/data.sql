...
-- President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Alice Johnson', 'I am Alice Johnson, your candidate for President in the Progressive Alliance. Together, we will lead with innovation and progress!', 1, 1);
-- Vice President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Michael Smith', 'Hello, I am Michael Smith, your candidate for Vice President in the Progressive Alliance. Let us unite for a brighter future!', 2, 1);
-- Secretary
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Emily Davis', 'Greetings, I am Emily Davis, your candidate for Secretary in the Progressive Alliance. Join me for transparency and efficiency!', 3, 1);
-- Treasurer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('David Wilson', 'I am David Wilson, your candidate for Treasurer in the Progressive Alliance. Let us manage resources wisely for success!', 4, 1);
-- Auditor
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Sophia Anderson', 'Hello, I am Sophia Anderson, your candidate for Auditor in the Progressive Alliance. Trust in our financial integrity!', 5, 1);
-- Public Relations Officer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('John Martinez', 'Greetings, I am John Martinez, your candidate for Public Relations Officer in the Progressive Alliance. We\'ll communicate progress effectively!', 6, 1);

-- Candidates for "Unity Party"
-- President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Daniel Brown', 'I am Daniel Brown, your candidate for President in the Unity Party. Together, we\'ll build a united and prosperous future!', 1, 2);
-- Vice President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Olivia Miller', 'Hello, I am Olivia Miller, your candidate for Vice President in the Unity Party. Unity leads to progress!', 2, 2);
-- Secretary
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('William Davis', 'Greetings, I am William Davis, your candidate for Secretary in the Unity Party. Efficiency and unity are our goals!', 3, 2);
-- Treasurer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Ava Smith', 'I am Ava Smith, your candidate for Treasurer in the Unity Party. We\'ll manage resources wisely for success!', 4, 2);
-- Auditor
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('James Wilson', 'Hello, I am James Wilson, your candidate for Auditor in the Unity Party. Trust in our financial integrity!', 5, 2);

INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Sophia Anderson', 'Greetings, I am Sophia Anderson, your candidate for Public Relations Officer in the Unity Party. Effective communication is key!', 6, 2);

-- Candidates for "Green Visionaries"
-- President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Liam Anderson', 'I am Liam Anderson, your candidate for President in the Green Visionaries. Let us lead the way towards a greener future!', 1, 3);
-- Vice President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Emma Wilson', 'Hello, I am Emma Wilson, your candidate for Vice President in the Green Visionaries. Green progress starts with unity!', 2, 3);
-- Secretary
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Aiden Davis', 'Greetings, I am Aiden Davis, your candidate for Secretary in the Green Visionaries. Transparency and eco-friendliness are our goals!', 3, 3);
-- Treasurer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Olivia Smith', 'I am Olivia Smith, your candidate for Treasurer in the Green Visionaries. We will manage resources for a sustainable future!', 4, 3);
-- Auditor
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Noah Brown', 'Hello, I am Noah Brown, your candidate for Auditor in the Green Visionaries. Trust in our eco-friendly financial practices!', 5, 3);
-- Public Relations Officer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Sophia Martinez', 'Greetings, I am Sophia Martinez, your candidate for Public Relations Officer in the Green Visionaries. Effective communication for a greener world!', 6, 3);

-- Candidates for "Innovation Forward"
-- President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Lucas Johnson', 'I am Lucas Johnson, your candidate for President in Innovation Forward. We will lead with innovation and progress!', 1, 4);
-- Vice President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Ella Smith', 'Hello, I am Ella Smith, your candidate for Vice President in Innovation Forward. Let us innovate for a brighter future!', 2, 4);
-- Secretary
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Jackson Davis', 'Greetings, I am Jackson Davis, your candidate for Secretary in Innovation Forward. Efficiency and innovation are our goals!', 3, 4);
-- Treasurer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Mia Wilson', 'I am Mia Wilson, your candidate for Treasurer in Innovation Forward. We will manage resources for innovative success!', 4, 4);
-- Auditor
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Aiden Anderson', 'Hello, I am Aiden Anderson, your candidate for Auditor in Innovation Forward. Trust in our innovative financial practices!', 5, 4);
-- Public Relations Officer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Sophia Davis', 'Greetings, I am Sophia Davis, your candidate for Public Relations Officer in Innovation Forward. Effective communication for an innovative world!', 6, 4);

-- Candidates for "Equality for All"
-- President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Ethan Brown', 'I am Ethan Brown, your candidate for President in Equality for All. Together, we will champion equal rights and social justice!', 1, 5);
-- Vice President
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Olivia Martinez', 'Hello, I am Olivia Martinez, your candidate for Vice President in Equality for All. Let us unite for a more equal society!', 2, 5);
-- Secretary
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Liam Wilson', 'Greetings, I am Liam Wilson, your candidate for Secretary in Equality for All. Transparency and equality are our goals!', 3, 5);
-- Treasurer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Emma Smith', 'I am Emma Smith, your candidate for Treasurer in Equality for All. We will manage resources for a fairer future!', 4, 5);
-- Auditor
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Noah Davis', 'Hello, I am Noah Davis, your candidate for Auditor in Equality for All. Trust in our commitment to social justice!', 5, 5);
-- Public Relations Officer
INSERT INTO candidate (name, introduction, candidate_role_id, partylist_id)
VALUES ('Sophia Anderson', 'Greetings, I am Sophia Anderson, your candidate for Public Relations Officer in Equality for All. Effective communication for social change!', 6, 5);
